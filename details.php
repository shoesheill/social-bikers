...
<script>  
    ...
    <div class="container">
             ...
             <div class="logo">
						<p align="right"><form name="search" method="post"  action="search/findme.php">
				...
				<div class="details-left-slider">
				    <div class="grid images_3_of_2">
					 ...
					 <div class="details-left-info">
							...
							<h4></h4>
							<p><label>RS</label> <?php echo $price;?>/day
							
							<form action="log.php" onClick="Please Login First">
			 ...
			 echo "<div class=\"product\">";
					 echo "<div class=\"product-desc\">";
						 ...
						 echo "<div class=\"prod1-desc\">";
								echo "<h5><a class=\"product_link\" href=\"details.php?model=$modeldb\">$name</a></h5>";
