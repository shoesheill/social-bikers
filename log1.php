...
<div class="container">
             ...
             <div class="logo">
				  ...
				  <div class="top-nav" align="right">										 
					   ...
					   <ul class="nav">
						  <li class="dropdown1"><a href="index.php"><h4><strong><font color="#000000"> Home</font> </strong></h4></a>
							  <!--<ul class="dropdown2">
						  ...
						  <li class="dropdown1"><a href="reg.php"><h4><strong><font color="#000000">Rgister</font></strong></h4></a>
							 <!--<ul class="dropdown2">
...
<div class="dropdown" >
  ...
  <div class="id"><font color="#FFFFFF"> <h3>Logged Out Sucessfully</font></p></h3>
  </div>
