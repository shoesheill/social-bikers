...
?>
				  ...
				  <div class="top-nav">										 
					   ...
					   <ul class="nav">
						  <li class="dropdown1"><p align="right"> &nbsp;&nbsp;&nbsp;<a href="index1" ><img src="images/gear.png" height="50" width="50"></a></p>
                          <ul class="dropdown1">
		   ...
		   <?php
				...
				while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
					...
					if(strcmp("ROAD",$type)==0){
						echo "<a href=\"details1.php?model=$modeldb\"><div class=\"bike\">";				 
						...
						echo 		"<a href=\"recommend1.php?model=$modeldb\">Quick View</a>";
						echo "</div>";
					    echo  "</div></a>";
					}
