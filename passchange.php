				  ...
				  <div class="top-nav" align="right">										 
					   ...
					   <ul class="nav">
                          ...
                          <ul class="dropdown1">
									...
									<li><a href="index1.php"><h4><font color="#000000">Home</font></h4></a></li>
...
<form action="passwordchange.php?username=<?php echo $user;?>" method="post">
<label>

Old Password:<input type="password" name="oldpass"  required="required"  size="20" /> &nbsp;
...
<input type ="submit"  onclick="myFunction()" value="Change" name="submit" > <br/>
